...
/**
 * This is a container class holding the configuration for the CREXDATA optimizer. The method {@link
 * #create()} provides the functionality to create a dummy {@link OptimizerConfig}.
 *
 * @author Fabian Temme
 * @since 0.1.0
 * @deprecated since 0.1.0 (INF-61), cause there is no configuration JSON for the CREXDATA optimizer
