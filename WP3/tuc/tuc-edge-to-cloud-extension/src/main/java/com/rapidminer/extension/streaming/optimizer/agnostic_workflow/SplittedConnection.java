 ...
 * splitted after the optimization of the CREXDATA optimizer (e.g. the optimizer places the operators
...
public class SplittedConnection {
	...
	private boolean isBetweenEdgeProcessingOperators;
	/**
	...
	public boolean isBetweenEdgeProcessingOperators() {
		return isBetweenEdgeProcessingOperators;
	}

	public SplittedConnection setBetweenEdgeProcessingOperators(boolean betweenEdgeProcessingOperators) {
		isBetweenEdgeProcessingOperators = betweenEdgeProcessingOperators;
		return this;
	}
	/**
