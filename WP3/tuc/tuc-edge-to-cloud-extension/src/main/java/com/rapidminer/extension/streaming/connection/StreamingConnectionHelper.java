...
public class StreamingConnectionHelper {
	...
	public static final Map<String, ConnectionHandler> CONNECTION_HANDLER_MAP = createConnectionHandlerMap();
	 ...
	 */
	public static Map<String, ConnectionHandler> createConnectionHandlerMap() {
		return new ImmutableMap.Builder<String, ConnectionHandler>()
			...
			.put(RTSAConnectionHandler.getInstance().getType(), RTSAConnectionHandler.getInstance())
			.build();
	}
	...
	public static ConnectionInformationSelector createStreamConnectionSelector(Operator operator, String portName) {
		return new ConnectionInformationSelector(operator.getInputPorts().createPort(portName, ConnectionInformationContainerIOObject.class), null, operator, null) {
