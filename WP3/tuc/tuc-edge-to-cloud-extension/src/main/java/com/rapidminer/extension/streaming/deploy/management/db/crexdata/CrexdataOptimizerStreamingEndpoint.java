 ...
 */
package com.rapidminer.extension.streaming.deploy.management.db.crexdata;/*
 ...
 * @since 0.6.2
 */
public class CrexdataOptimizerStreamingEndpoint extends StreamingEndpoint {
	...
	public CrexdataOptimizerStreamingEndpoint() {
		this(null, null, null, 30, 10, null, null);
	}

	public CrexdataOptimizerStreamingEndpoint(String connectionLocation, OptimizerConnection optimizerConnection,
	...
	public OptimizerResponse waitForNewPlanForDeployment(int pollingTimeOut) throws InterruptedException {
        ...
        LOGGER.info("At CrexdataOptimizerStreamingEndpoint - waitForNewPlanForDeployment - response received");
	...
	public boolean equals(Object o) {
        ...
        CrexdataOptimizerStreamingEndpoint that = (CrexdataOptimizerStreamingEndpoint) o;
