...
public class StreamingNest extends OperatorChain {
	...
	public void doWork() throws OperatorException {
		...
		// If we have a connection to an CREXDATA Optimizer Service this is a benchmarking request and we just serialize
		...
		try (ClassLoaderSwapper cls = ClassLoaderSwapper.withContextClassLoader(getPluginLoader())) {
			...
			StreamConnectionHandler handler = (StreamConnectionHandler) StreamingConnectionHelper.CONNECTION_HANDLER_MAP.get(connType);
