...
public class OptimizationParameters {
	...
	/**
	 * This enum provides the currently supported optimization algorithms of the CREXDATA optimizer.
	 *
	 * @author Fabian Temme
	 * @since 0.1.0
	 */
	public enum OptimizerAlgorithm {
		...
		/**
		 * Returns the key used by the CREXDATA optimizer for this algorithm.
		 *
		 * @return key used by the CREXDATA optimizer for this algorithm
		 */
